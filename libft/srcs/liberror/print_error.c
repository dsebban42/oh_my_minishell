...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/10/15 13:35:37 by dsebban           #+#    #+#             */
/*   Updated: 2016/10/28 14:55:25 by dsebban          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	tab1(int err_type)
{
	...
	ft_putendl_fd(lst_error[err_type - 1], 2);
}

static void	tab2(int err_type)
{
	static const char *lst_error[] = {
